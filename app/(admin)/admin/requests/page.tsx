...
export default function DatasetRequestsPage() {
  return (
    <div className="flex-1 flex flex-col" style={{ background: "#0F0F14" }}>
      <Navbar title="Dataset Requests" isAdmin={true} />
      <main className="flex-1 p-6 flex flex-col items-center justify-center">
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#9090A0" }}>
            The <strong>Dataset Requests</strong> module is currently in development and will be available in the next release of the Locara Atlas platform.
          </p>
        </div>
      </main>
    </div>
