...
export default function OrganizationsManagementPage() {
  return (
    <div className="flex-1 flex flex-col" >
      <Navbar title="Organizations Management" isAdmin={true} />
      <main className="flex-1 p-6 flex flex-col items-center justify-center">
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#9090A0" }}>
            The <strong>Organizations Management</strong> module is currently in development and will be available in the next release of the Locara Atlas platform.
          </p>
        </div>
      </main>
    </div>
